...
public class RefreshListView extends ListView implements OnScrollListener {
	...
	private boolean isLoadingMore = false; // 未处于正在加载中
	...
	private void initHeaderView() {
		headerView = LayoutInflater.from(getContext()).inflate(R.layout.listview_header, null, false);
	...
	private void initFooterView() {
		footerView = LayoutInflater.from(getContext()).inflate(R.layout.listview_footer, null, false);
